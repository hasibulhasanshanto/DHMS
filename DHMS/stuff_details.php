										...
										<div class="row">
											<div class="col-md-9">
												<div class="input-group input-group-sm mb-3"> 
												  <input type="text" name="s_search" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder=" Search By Phone No/ Name / Designation">
												</div>
											</div>
											<div class="col-md-3">
